...
public class PreferencesDialog extends javax.swing.JDialog {
    ...
    String vcfOrg, coverageOrg, geneDataOrg,cacheOrg;
    /**
    ...
    public PreferencesDialog(java.awt.Frame parent, boolean modal) {        
        ...
        vcfField.setText(ExtractorDefinitions.getVcfFile());        
        coverageField.setText(ExtractorDefinitions.COVERAGE_PATH);        
        geneDataField.setText(ExtractorDefinitions.DATAFILES_PATH);        
        cacheField.setText(ExtractorDefinitions.CACHED_PATH);
        
        vcfOrg = vcfField.getText();
        coverageOrg = coverageField.getText();
    ...
    private void initComponents() {
        ...
        coverageButton = new javax.swing.JButton();
        coverageField = new javax.swing.JTextField();
        ...
        vcfField = new javax.swing.JTextField();
        ...
        jLabel1.setText("Local Data File:");
        ...
        filePreferencePanel.add(jLabel1, gridBagConstraints);

        coverageButton.setText("Browse...");
        coverageButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                coverageButtonActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        filePreferencePanel.add(coverageButton, gridBagConstraints);

        coverageField.setText("Path to coverage folder...");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        filePreferencePanel.add(coverageField, gridBagConstraints);

        jLabel2.setText("Coverage Folder: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        filePreferencePanel.add(jLabel2, gridBagConstraints);
        ...
        geneDataField.setText("Path to gene data folder...");
        ...
        jLabel3.setText("GeneData Folder: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        filePreferencePanel.add(vcfButton, gridBagConstraints);

        vcfField.setText("Path to local data file...");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        filePreferencePanel.add(vcfField, gridBagConstraints);
    ...
    private void vcfButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_vcfButtonActionPerformed
        parent.specifyVcfFolder();
        vcfField.setText(ExtractorDefinitions.getVcfFile());
    }//GEN-LAST:event_vcfButtonActionPerformed

    private void coverageButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_coverageButtonActionPerformed
        parent.specifyCoverageFolder();
        coverageField.setText(ExtractorDefinitions.COVERAGE_PATH);
    }//GEN-LAST:event_coverageButtonActionPerformed
    ...
    private void cancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelButtonActionPerformed
        parent.setVcfFolder(vcfOrg);
        parent.setCoverageFolder(coverageOrg);
    ...
    private javax.swing.JButton coverageButton;
    private javax.swing.JTextField coverageField;
    ...
    private javax.swing.JTextField vcfField;
